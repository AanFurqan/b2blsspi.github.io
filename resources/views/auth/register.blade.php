            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end fw-bold">{{ __('Name')
                                }}</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-1 offset-md-4 d-inline-block">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('Register') }}
                                </button>
                            </div>
                            <a class="col-2  btn btn-link" href="{{ route('login') }}">Login</a>
                        </div>
                    </form>
                </div>
            </div>
